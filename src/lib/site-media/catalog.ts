...
export const SITE_MEDIA_DEFINITIONS = [
  ...
  },
  {
    ...
    defaultSrc: "/images/estrutura-churrasqueira.jpg",
  ...
  },
  {
    ...
    defaultSrc: "/images/estrutura-bar-coberto.jpg",
    alt: "Área coberta do bar da Arena Sul com mesas e cadeiras.",
    recommendation: "Foto vertical 3:4 · mínimo 1200 px de altura",
    previewAspect: "3 / 4",
  },
  {
    ...
    defaultSrc: "/images/estrutura-bar-convivencia.jpg",
    alt: "Área externa de convivência com vista para as quadras de areia.",
